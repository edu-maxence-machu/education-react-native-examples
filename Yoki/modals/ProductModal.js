...
export default class BarCodeModal extends Component{
  ...
  exitModaAndAsk = () => {
    Alert.alert(
      ...
      [
        {text: 'Quit', onPress: () => this.props.setModalVisible(false)},
        {text: 'Save & Quit', onPress: () => this.props.saveAndQuit()},
      ],
      { cancelable: false }
    )
  }
      ...
      <Modal
        ...
        <View style={{flex: 1}}>
          ...
          <ScrollView contentContainerStyle={styles.productInfoContainer} style={{flex: 1}}>
            ...
            <Text style={globalTextStyle.content}>  {product.ingredients_text} </Text>
